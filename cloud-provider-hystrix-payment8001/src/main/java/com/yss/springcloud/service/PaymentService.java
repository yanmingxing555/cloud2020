...
public class PaymentService {
     ...
     * @return
     */
    @HystrixCommand(fallbackMethod = "paymentInfo_TimeOutHandler"/*指定善后的方法名称*/,
            commandProperties = {
            @HystrixProperty(
    ...
    public String paymentInfo_TimeOut(Integer id){
        ...
        return "线程池:"+Thread.currentThread().getName()+"paymentInfo_TimeOut,id: "+id+"\t"+"O(∩_∩)O，耗费(秒)"+sleepTime;
    }
    //用来善后的方法
